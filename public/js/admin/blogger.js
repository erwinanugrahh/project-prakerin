...
var table=$('#bloggers_table').DataTable({
    ...
    "columns": [
        ...
        {data:"name",className:'align-middle',orderable:true,sortable:true},
        {data:"email",className:'align-middle'},
        {data:"blog_count",name:'blog_count',className:'align-middle'},
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: `Berhasil terhapus, ${result.count} blogger terhapus.`
                        })
                    }
                })
            }
