...
<div id="comment-{{ $comment->getKey() }}" class="media">
    <img loading="lazy" class="comment-avatar" alt="author" src="{{ asset($coment->commenter->avatar??'/admin/img/default-avatar.png') }}">
    <div class="media-body">
        ...
        <div>
            @can('reply-to-comment', $comment)
                <button data-toggle="modal" data-target="#reply-modal-{{ $comment->getKey() }}" class="btn btn-sm font-weight-bold comment-reply">@lang('comments::comments.reply')</button>
            @endcan
